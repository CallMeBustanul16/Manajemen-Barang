...
export default function PemasokHome() {
    ...
    const filteredData = pemasok.filter(item =>
                ...
                {paginatedData.length === 0 ? (
                    <div className="text-center py-12">
                        <p className="text-gray-500 dark:text-gray-400">
                            {search ? 'Tidak ada pemasok yang sesuai dengan pencarian' : 'Belum ada data pemasok'}
                        </p>
                    </div>
                ) : (
                    <>
                            ...
                            <table className="w-full text-sm text-left">
                                <thead className="bg-gray-50 dark:bg-gray-700/50 text-gray-700 dark:text-gray-300 border-b border-gray-200 dark:border-gray-700">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 font-semibold">Nama Pemasok</th>
                                        <th className="px-6 py-3 font-semibold hidden md:table-cell">Kontak</th>
                                        <th className="px-6 py-3 font-semibold hidden lg:table-cell">Alamat</th>
                                    ...
                                    {paginatedData.map((item, index) => (
                                        <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 hidden lg:table-cell">
                                                {item.alamat && (
                                                    <div className="flex items-start gap-1 text-gray-500 dark:text-gray-400 max-w-xs">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <button
                                                        onClick={() => handleDelete(item.id, item.nama_pemasok)}
